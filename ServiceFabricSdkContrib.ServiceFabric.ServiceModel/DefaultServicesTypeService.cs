...
// Type: ServiceFabricSdkContrib.ServiceFabric.ServiceModel.DefaultServicesTypeService
...
namespace ServiceFabricSdkContrib.ServiceFabric.ServiceModel
{
  ...
  public class DefaultServicesTypeService
  {
    ...
    private DefaultServicesTypeServiceServicePackageActivationMode servicePackageActivationModeField;
    ...
    [XmlAttribute]
    [DefaultValue(DefaultServicesTypeServiceServicePackageActivationMode.SharedProcess)]
    public DefaultServicesTypeServiceServicePackageActivationMode ServicePackageActivationMode
    {
      get
      {
    ...
    {
      this.servicePackageActivationModeField = DefaultServicesTypeServiceServicePackageActivationMode.SharedProcess;
    }
  }
}
