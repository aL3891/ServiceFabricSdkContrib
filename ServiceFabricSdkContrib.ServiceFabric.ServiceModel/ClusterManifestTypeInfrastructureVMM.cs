...
// Type: ServiceFabricSdkContrib.ServiceFabric.ServiceModel.ClusterManifestTypeInfrastructureVMM
...
namespace ServiceFabricSdkContrib.ServiceFabric.ServiceModel
{
  ...
  public class ClusterManifestTypeInfrastructureVMM
  {
    private VMMTierType[] tiersField;

    [XmlArrayItem("Tier", IsNullable = false)]
