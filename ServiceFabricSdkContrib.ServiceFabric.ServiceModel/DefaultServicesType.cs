...
// Type: ServiceFabricSdkContrib.ServiceFabric.ServiceModel.DefaultServicesType
...
namespace ServiceFabricSdkContrib.ServiceFabric.ServiceModel
{
  ...
  public class DefaultServicesType
  {
    private object[] itemsField;

    [XmlElement("Service", typeof (DefaultServicesTypeService))]
    [XmlElement("ServiceGroup", typeof (DefaultServicesTypeServiceGroup))]
    public object[] Items
    {
      get
      {
