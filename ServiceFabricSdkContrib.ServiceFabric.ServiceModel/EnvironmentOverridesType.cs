...
// Type: ServiceFabricSdkContrib.ServiceFabric.ServiceModel.EnvironmentOverridesType
...
namespace ServiceFabricSdkContrib.ServiceFabric.ServiceModel
{
  ...
  public class EnvironmentOverridesType
  {
    private EnvironmentVariableType[] environmentVariableField;
    private string codePackageRefField;

    [XmlElement("EnvironmentVariable")]
    public EnvironmentVariableType[] EnvironmentVariable
    {
      get
      {
